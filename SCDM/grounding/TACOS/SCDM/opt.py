...
def default_options():
    ...
    options['video_fts_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\data\\TACOS\\tacos_c3d_fc6_nonoverlap.hdf5'
    options['video_data_path_train'] = 'D:\\Data\\Text-to-Clip\\SCDM\\data\\TACOS\\h5py\\shuffle_train\\train.txt'
    options['video_data_path_test'] = 'D:\\Data\\Text-to-Clip\\SCDM\\data\\TACOS\\h5py\\test\\test.txt'
    options['wordtoix_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\TACOS\\words\\wordtoix.npy'
    options['ixtoword_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\TACOS\\words\\ixtoword.npy'
    options['word_fts_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\TACOS\\words\\word_glove_fts_init.npy'
    options['model_save_dir'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\TACOS\\model'
    options['result_save_dir'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\TACOS\\result'
    options['words_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\TACOS\\words'
