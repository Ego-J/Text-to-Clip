...
def default_options():
    ...
    options['word_embedding_path'] ='D:\\Data\\Text-to-Clip\\SCDM\\data\\glove.840B.300d_dict.npy'
    ...
    options['video_data_path_train'] = 'D:\\Data\\Text-to-Clip\\SCDM\\data\\Charades\\h5py\\train\\train.txt'
    options['video_data_path_test'] = 'D:\\Data\\Text-to-Clip\\SCDM\\data\\Charades\\h5py\\test\\test.txt'
    options['wordtoix_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\Charades-STA\\words\\wordtoix.npy'
    options['ixtoword_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\Charades-STA\\words\\ixtoword.npy'
    options['word_fts_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\Charades-STA\\words\\word_glove_fts_init.npy'
    options['pre_model_save_dir'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\Charades-STA\\model'
    options['pre_result_save_dir'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\Charades-STA\\result'
    options['words_path'] = 'D:\\Data\\Text-to-Clip\\SCDM\\grounding\\Charades-STA\\words'
